...
for ($x = 0; $x < count($rowambilstatustanggalibur); $x++) {
   ...
   $t++;
   $daftartanggalibur[$t] = '28-11-2020' ;
   $t++;
    $daftartanggalibur[$t] = '29-11-2020' ;
   $t++;
     $daftartanggalibur[$t] = '30-08-2020' ;
   $t++;
  $daftartanggalibur[$t] = '31-10-2020' ;
   $t++;
   $daftartanggalibur[$t] = '30-01-2021' ;
   $t++;
   $daftartanggalibur[$t] = '31-01-2021' ;
   $t++;
   $daftartanggalibur[$t] = '28-02-2021' ;
   $t++;
    $daftartanggalibur[$t] = '27-02-2021' ;
   $t++;
   $daftartanggalibur[$t] = '31-07-2021' ;
   $t++;
    $daftartanggalibur[$t] = '30-05-2021' ;
   $t++;
      $daftartanggalibur[$t] = '31-12-2020' ;
   $t++;
       $daftartanggalibur[$t] = '30-10-2021' ;
   $t++;
       $daftartanggalibur[$t] = '31-10-2021' ;
   $t++;
   ...
   $t++;
     $daftartanggalibur[$t] = '15-04-2022' ;
   $t++;
      $daftartanggalibur[$t] = '16-04-2022' ;
   $t++;
      $daftartanggalibur[$t] = '17-04-2022' ;
   $t++;
   $daftartanggalibur[$t] = '23-04-2022' ;
   $t++;
   $daftartanggalibur[$t] = '24-04-2022' ;
   $t++;
      $daftartanggalibur[$t] = '30-04-2022' ;
   $t++;
...
<section class="dar mb-5 text-center text-lg-left">
                ...
                <br>
                 ...
                 <form action="dataauploads.php" method="post" enctype="multipart/form-data" class="mb-4">
