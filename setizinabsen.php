			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                       ...
                       <!-- DataTales Example -->
                          <div class="card shadow mb-4">
                            <div class="card-header py-3">
                             <h4 class="card-title m-0 text-uppercase font-weight-bold">Daftar User Yang Boleh Absen Luar Kota</h4>
                            </div>
                                <div class="card-body">
                                 <h6>Period Filter:</h6>
                                 <div class="row">
                ...
                for($x = 0; $x < sizeof($arrayrdar); $x++){
                      $status = $arrayrdar[$x]["izinabsenlk"];
                      ...
                      if ($status != "-"){
                   $echosts = '<span class="badge badge-success">Izin</span>';
                          $echostatus = 'bgcolor="green"';
                      }else{
                     $echosts = '<span class="badge badge-danger">Tidak</span>';
                  ...
                  <tr> 
                    ...
                    <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="setizinlk.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&tipe=iya"><button style="font-size: 99%;" class="btn btn-success">Set Izin</button></td></a>
                    <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="setizinlk.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&tipe=tidak"><button style="font-size: 99%;" class="btn btn-danger">Set Tidak</button></td></a> 
