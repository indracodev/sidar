...
if($do == "viewall"){
  ...
  $pid = 0;
  $notLike = "Gift Set";
  $getProduct = $conn->query("SELECT * FROM masterproduk WHERE status = 'aktif' AND namaproduk NOT LIKE '%".$notLike."%' ");
  ...
  $notLike = "Gift Set";
  $getProduct = $conn->query("SELECT * FROM masterproduk WHERE status = '".$statusVal."' AND categoryname LIKE '%".$filterVal."%' AND namaproduk NOT LIKE '%".$notLike."%' ".$sortSQL);
  while($fetchProduct = $getProduct->fetch_assoc()){
    $thisItemPack = $fetchProduct["kemasan"];
    if($thisItemPack == "Can Drip Capsule"){
      $viewThisItemPack = "";
  ...
  $notLike = "Gift Set";
  $getProduct = $conn->query("SELECT * FROM masterproduk WHERE status = '".$statusVal."' AND kind LIKE '%".$filterVal."%' AND namaproduk NOT LIKE '%".$notLike."%' ".$sortSQL);
  while($fetchProduct = $getProduct->fetch_assoc()){
    $thisItemPack = $fetchProduct["kemasan"];
    if($thisItemPack == "Can Drip Capsule"){
      $viewThisItemPack = "";
  ...
  if(!isset($_GET["id"])){
    ...
    if($prodID == ""){
      ...
      $statusVal = "aktif";
      $notLike = "Gift Set";
      $getProduct = $conn->query("SELECT * FROM masterproduk WHERE idproduk = '".$prodID."' AND status = '".$statusVal."' AND namaproduk NOT LIKE '%".$notLike."%' ");
      ...
      if($countProduct != 0){
        ...
        $daJson[$pid]["gambar"] = $fetchProduct["gambar"];
