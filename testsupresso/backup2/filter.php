...
if($do == "main"){
  if(!isset($_POST["formid"])){
    ...
    if($sortNoVal >= 2){
      ...
      if($wgh50 == 1 || $wgh60 == 1 || $wgh100 == 1 || $wgh200 == 1 || $wgh500 == 1 || $wgh1000 == 1){
        $countThis = 0;
        $sqlGrm = " AND gramature IN "."(";
        if($wgh50 == 1){
          if($countThis >= 1){
            $commaval = ", ";
          } else {
          ...
          $sqlGrm = $sqlGrm.$commaval.'"50g (10g x 5 Sachets)"';
          $countThis++;
        }
        if($wgh60 == 1){
          if($countThis >= 1){
          ...
          $sqlGrm = $sqlGrm.$commaval.'"60g (6g x 10 Capsules)"';
          $countThis++;
        }
        if($wgh100 == 1){
          if($countThis >= 1){
      ...
      //SQL
      include "config.php";
      $sqlResult = $sql.$sqlcategory.$sqltype.$sqlForm.$sqlPck.$sqlGrm.$sqlSrt;
