...
$notelatnya = $_GET["notelat"] ;
$keuser = $_SESSION["Ke"] ;
$namaa = $_GET["nama"];
$lokasikerja = $_SESSION["Lokasikerja"] ;
$pecah = explode("/", $notelatnya);
$iduser = $pecah[0];
...
$infotelat = "SELECT * FROM formtelat WHERE notelat = '".$notelatnya."';";
			  ...
			  <section class="dar mb-5">
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3">
                      <h5 class="card-title m-0 text-uppercase font-weight-bold">Izin Terlambat Masuk Kantor</h5>
                    </div>
                    <div class="card-body">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="date" name="tgltelat" class="form-control" id="tgltelat" value="<?php echo $tanggaltelat ?>" placeholder="dd-mm-yyyy" required="required" disabled>
                          </div>
                            <div class="form-group col-md-6">
                              <label for="inputEmail4">Jam Telat</label>
                              <input type="time" value="<?php echo $masukjam ?>" name="timetelat" class="form-control timepicker" id="time" step="1" placeholder="" required="required" disabled>
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <textarea rows="3" name="alasan" class="form-control" id="alasan" placeholder="Alasan" required="required" disabled><?php echo $alasanya;?></textarea>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                           ...
                           <a href="https://sidar.id/formtelat.php" class="btn btn-outline-dark border-1">
