...
if ($namaa == "HRD IB" || $namaa == "Admin HRD IB" || $namaa == "HRD IGI Pasuruan" || $namaa == "HRD IGI Gresik" || $namaa == "HRD SDA" ){
...
$infodar = "SELECT * FROM masteruser WHERE lokasikerja = 'ib' and pw = '-' ";
			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                <div class="container-fluid">
                      <div class="kiri" >
                            <form method="post" action="formtelat.php">
                       ...
                       <!-- DataTales Example -->
                          <div class="card shadow mb-4">
                            <div class="card-header py-3">
                             <h4 class="card-title m-0 text-uppercase font-weight-bold">Kirim Notif Telat Ke User</h4>
                            </div>
                                <div class="card-body">
                                 <h6>Period Filter:</h6>
                                 <div class="row">
                ...
                for($x = 0; $x < sizeof($arrayrdar); $x++){
                  ...
                  <tr> 
                    <td scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="addformtelathcs.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["nama"] ?></td></a>
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="addformtelathcs.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["departemen"] ?></td></a>
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="addformtelathcs.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["divisi"] ?></td></a>
                    <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="addformtelathcs.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $echosts ?></td></a>
                    <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="addformtelathcs.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><button class="btn btn-success">Kirim Notif Telat</button></td></a> 
