...
<section class="dar mb-5 text-center text-lg-left">
                ...
                <br>
                 ...
                 <form action="datauploads.php" method="post" enctype="multipart/form-data" class="mb-4">
