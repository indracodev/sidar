...
$infodar = "SELECT masteruser.nama, masteruser.nik, masteruser.departemen, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.urid, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE tanggal BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND dar.iduser='".$iduser."' AND (dar.status='Pending Absence' OR dar.status='Absence') ORDER BY dar.tanggaldar DESC";
...
$infodar = "SELECT masteruser.nama, masteruser.nik, masteruser.departemen, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE dar.iduser='".$iduser."' AND (dar.status='Pending Absence' OR dar.status='Absence') ORDER BY dar.tanggaldar DESC;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
}
              ...
              <section class="dar mb-5">
                       ...
                       <!-- DataTales Example -->
                          <div class="card shadow mb-4">
                            <div class="card-header py-3">
                             <h4 class="card-title m-0 text-uppercase font-weight-bold">MONITORING USER <?php echo '"'. $namenya . '"' ?></h4>
                            </div>
                            
                              <div class="kiri" style="margin-left: 15px;">
                            <form method="post" action="confirmabsence.php">
                               ...
                               <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <h6 style="display:flex;justify-content:center;">Period Filter:</h6>
                                 ...
                                 <div class="row" style="<?php echo $aktifbaca ; ?>">
                                      <label> 
                                     <h6 style="display:flex;justify-content:center;">Export Excel:</h6>
                                  <div class='col-sm-3' style="max-width:100%;flex-basis:100%;">
                                    <div class="form-group">
                                        <div class='' id=''>
                                    
                                        <form method="POST" action="export_excel.php">
                                   <input type="hidden" class="form-control" name="idaser" value="<?php echo $iduser ?>"  id="idaser">
                                ...
                                <table class="table table-bordered" id="dataTablee" width="970px" cellspacing="0">
                                  <thead>
                                    <tr>
                                      ...
                                      <th>DAR Sent</th>
                                      <th>Status</th>
                                      <th style="display:none" >Dibaca</th>
                ...
                $echosts = '<span class="badge badge-decline" style="color:white;">Decline</span>';  
                  ...
                  <tr> 
                    ...
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="#"><?php echo $arrayrdar[$x]["nik"] ?> </td></a>
...
echo $darsend;                  
                   ...
                   <td style="display:none"  ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href=""><?php echo $wktglbaca ?></td></a> 
