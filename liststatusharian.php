...
if ($getstat == 'nodata'){
if (date('H') >= 16) { 
$infodar = "SELECT id, nama, unitusaha, departemen FROM masteruser WHERE (id = '".$iduser."' OR ke='".$iduser."' OR ke2='".$iduser."' OR ke3='".$iduser."' OR ke4='".$iduser."' OR ke5='".$iduser."') AND ( id NOT IN (SELECT iduser FROM dar WHERE tanggaldar = '".$tglhariini."' AND (iduser='".$iduser."' OR ke='".$iduser."' OR ke2='".$iduser."' OR ke3='".$iduser."' OR ke4='".$iduser."' OR ke5='".$iduser."' )))";

$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);  
}else{
$infodar = "SELECT id, nama, unitusaha, departemen FROM masteruser WHERE (id = '".$iduser."' OR ke='".$iduser."' OR ke2='".$iduser."' OR ke3='".$iduser."' OR ke4='".$iduser."' OR ke5='".$iduser."') AND ( id NOT IN (SELECT iduser FROM dar WHERE tanggaldar = '".$tglkemarindar."' AND (iduser='".$iduser."' OR ke='".$iduser."' OR ke2='".$iduser."' OR ke3='".$iduser."' OR ke4='".$iduser."' OR ke5='".$iduser."' )))";
...
if($getstat == 'ontime'){
if (date('H') >= 16) {     
$infodar = "SELECT masteruser.nama, masteruser.unitusaha, masteruser.departemen, dar.status, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE status = '".$getstat."' AND tanggaldar = '".$tglhariini."' AND (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) ORDER BY dar.tanggal DESC, dar.jam DESC;";

$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);    
}else{
$infodar = "SELECT masteruser.nama, masteruser.unitusaha, masteruser.departemen, dar.status, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE status = '".$getstat."' AND tanggaldar = '".$tglkemarindar."' AND (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) ORDER BY dar.tanggal DESC, dar.jam DESC;";
...
if($getstat == 'late'){
if (date('H') >= 16) {         
$infodar = "SELECT masteruser.nama, masteruser.unitusaha, masteruser.departemen, dar.status, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE status = '".$getstat."' AND dar.tanggaldar = '".$tglhariini."' AND (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) ORDER BY dar.tanggal DESC, dar.jam DESC;";

$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);    
}else{
$infodar = "SELECT masteruser.nama, masteruser.unitusaha, masteruser.departemen, dar.status, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE status = '".$getstat."' AND dar.tanggaldar = '".$tglkemarindar."' AND (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) ORDER BY dar.tanggal DESC, dar.jam DESC;";
...
if (date('H') >= 16) {      
$infodar = "SELECT masteruser.nama, masteruser.unitusaha, masteruser.departemen, dar.status, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE (status = '".$getstat."' OR status = 'Pending Absence') AND tanggaldar = '".$tglhariini."' AND (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) ORDER BY dar.tanggal DESC, dar.jam DESC;";

$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);       
}else{
    
$infodar = "SELECT masteruser.nama, masteruser.unitusaha, masteruser.departemen, dar.status, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE (dar.status = '".$getstat."' OR dar.status = 'Pending Absence') AND dar.tanggaldar = '".$tglkemarindar."' AND (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) ORDER BY dar.tanggal DESC, dar.jam DESC;";    
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);  
}    
}
                       ...
                       <!-- DataTales Example -->
                          <div class="card shadow mb-4">
                            <div class="card-header py-3">
                             <h4 class="card-title m-0 text-uppercase font-weight-bold">Daftar Harian Status <?php echo $getstat ?></h4>
                            </div>
