                ...
                <div class="container-fluid">
                    ...
                    <div class="card-body">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="date" name="tglcuti" class="form-control" id="tglcuti" value="<?php echo $cutipadatanggal ?>" placeholder="dd-mm-yyyy" required="required" disabled>
                          </div>
                            <div class="form-group col-md-6">
                              <label for="inputEmail4">Tanggal Masuk Kerja</label>
                              <input type="date" name="tglmasukerja" class="form-control" id="tglmasukerja" value="<?php echo $cutisampaitanggal ?>" placeholder="dd-mm-yyyy" required="required" disabled>
