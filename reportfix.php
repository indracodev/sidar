...
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE dar.iduser='".$iduser."' ORDER BY dar.tanggaldar DESC, dar.jam DESC;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
mysqli_close($conn);
...
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) ORDER BY dar.tanggal DESC, dar.jam DESC;";
			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                ...
                $echosts = '<span class="badge badge-decline" style="color:white;">Decline</span>';  
                  ...
                  <tr> 
                    <td scope="row"> <form method="post" action="reportdetail.php">
<input type="text" style="display:none" value="<?php echo $arrayrdar[$x]["nodar"] ?>" name="idnya"><button class="buttonkolom" style="font-weight:<?php echo $sama ?>;" type="submit"> <?php echo $arrayrdar[$x]["unitusaha"] ?> </button></form></td> 
                    
                    <td scope="row"> <form method="post" action="reportdetail.php">
<input type="text" style="display:none" value="<?php echo $arrayrdar[$x]["nodar"] ?>" name="idnya"><button class="buttonkolom" style="font-weight:<?php echo $sama ?>;" type="submit"> <?php echo $arrayrdar[$x]["departemen"] ?></button></form></td> 
        
            <td scope="row"> <form method="post" action="reportdetail.php">
<input type="text" style="display:none" value="<?php echo $arrayrdar[$x]["nodar"] ?>" name="idnya"><button class="buttonkolom" style="font-weight:<?php echo $sama ?>;" type="submit"> <?php echo $arrayrdar[$x]["nama"] ?></button></form></td> 
                    
            <td scope="row"> <form method="post" action="reportdetail.php">
<input type="text" style="display:none" value="<?php echo $arrayrdar[$x]["nodar"] ?>" name="idnya"><button class="buttonkolom" style="font-weight:<?php echo $sama ?>;" type="submit"> <?php 
...
echo $darsend;                  
            ...
            <td scope="row"> <form method="post" action="reportdetail.php">
<input type="text" style="display:none" value="<?php echo $arrayrdar[$x]["nodar"] ?>" name="idnya"><button class="buttonkolom" style="font-weight:<?php echo $sama ?>;" type="submit"> <?php echo $echosts ?></button></form></td> 
