			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                       ...
                       <!-- DataTales Example -->
                          <div class="card shadow mb-4">
                            <div class="card-header py-3">
                             <h4 class="card-title m-0 text-uppercase font-weight-bold">List Of User</h4>
                            </div>
                                <div class="card-body">
                                 <h6>Period Filter:</h6>
                                 <div class="row">
                ...
                for($x = 0; $x < sizeof($arrayrdar); $x++){
                  ...
                  <tr> 
                    <td scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="editUser.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["nama"] ?></td> </a>
                    <td scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="editUser.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["username"] ?></td> </a>
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="editUser.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["departemen"] ?></td></a>
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="editUser.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["divisi"] ?></td></a>
                    <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="editUser.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php echo $echosts ?></td></a>
                    <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="editUser.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>"><button class="btn btn-success">Edit User</button></td></a> 
