...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE tanggal BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND masteruser.lokasikerja = 'ib' ORDER BY formcuti.cutipadatanggal DESC";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE AND (formcuti.alasan LIKE '".$searchingg."') AND masteruser.lokasikerja = 'ib' ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC;";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE masteruser.lokasikerja = 'ib' ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC LIMIT 70;";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE tanggal BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND masteruser.lokasikerja = 'IGI Purwosari' ORDER BY formcuti.cutipadatanggal DESC";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE AND (formcuti.alasan LIKE '".$searchingg."') AND masteruser.lokasikerja = 'IGI Purwosari' ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC;";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE masteruser.lokasikerja = 'IGI Purwosari' ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC LIMIT 70;";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE tanggal BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND masteruser.lokasikerja = 'IGI Bambe' ORDER BY formcuti.cutipadatanggal DESC";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE AND (formcuti.alasan LIKE '".$searchingg."') AND masteruser.lokasikerja = 'IGI Bambe' ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC;";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE masteruser.lokasikerja = 'IGI Bambe' ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC LIMIT 70;";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE tanggal BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND masteruser.lokasikerja = 'sda' ORDER BY formcuti.cutipadatanggal DESC";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE AND (formcuti.alasan LIKE '".$searchingg."') AND masteruser.lokasikerja = 'sda' ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC;";
...
$infodar = "SELECT masteruser.id, masteruser.nama, masteruser.nik, masteruser.departemen, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE masteruser.lokasikerja = 'sda' ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC LIMIT 70;";
...
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.divisi, masteruser.jumlahcuti, masteruser.kota, masteruser.unitusaha, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE (formcuti.iduser='".$iduser."' OR formcuti.iduserdelegasi='".$iduser."') ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC LIMIT 70;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
mysqli_close($conn);    
...
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.divisi, masteruser.jumlahcuti, masteruser.kota, masteruser.unitusaha, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuiatasan, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE (formcuti.iduser='".$iduser."' OR formcuti.iduserdelegasi='".$iduser."' OR formcuti.iduser='".$iduser."' OR formcuti.ke1='".$iduser."' OR formcuti.ke2='".$iduser."' OR formcuti.ke3='".$iduser."' OR formcuti.ke4='".$iduser."' OR formcuti.ke5='".$iduser."' ) AND (formcuti.alasan LIKE '".$searchingg."' OR masteruser.nama LIKE '".$searchingg."') ORDER BY formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC;";
...
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.divisi, masteruser.jumlahcuti, masteruser.kota, masteruser.unitusaha, formcuti.cutipadatanggal, formcuti.iduser, formcuti.keperluan, formcuti.jumlahcutihari, formcuti.menyetujuiatasan, formcuti.menyetujuidelegasi, formcuti.iduserdelegasi, formcuti.delegasikepada, formcuti.cutisampaitanggal, formcuti.alasan, formcuti.dibuatpadatgl, formcuti.ke1, formcuti.menyetujuiatasan, formcuti.mengetahuihcs, formcuti.nocuti FROM formcuti INNER JOIN masteruser ON masteruser.id=formcuti.iduser WHERE (formcuti.iduser='".$iduser."' OR formcuti.iduserdelegasi='".$iduser."' OR formcuti.iduser='".$iduser."' OR formcuti.ke1='".$iduser."' OR formcuti.ke2='".$iduser."' OR formcuti.ke3='".$iduser."' OR formcuti.ke4='".$iduser."' OR formcuti.ke5='".$iduser."' ) ORDER BY formcuti.id DESC, formcuti.cutipadatanggal DESC, formcuti.cutisampaitanggal DESC LIMIT 70;";
			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                ...
                for($x = 0; $x < sizeof($arrayrdar); $x++){
                       if($arrayrdar[$x]["iduserdelegasi"] != $iduser && $arrayrdar[$x]["menyetujuidelegasi"] != "Setuju" && $_SESSION["Level"] == "admin"){
                      $x++;
                  }else{
