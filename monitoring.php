              ...
              <section class="dar mb-5">
                ...
                $echosts = '<span class="badge badge-late">Late2</span>';  
                  ...
                  <tr>
                    ...
                    <td scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="status.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["unitusaha"] ?></td> </a>   
