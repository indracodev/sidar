			  ...
			  <section class="dar mb-5">
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3">
                      <h5 class="card-title m-0 text-uppercase font-weight-bold">Permohonan izin terlambat masuk kantor</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="tambahdatatelat.php">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="date" min="<?php echo date('Y-m-d', strtotime(' +1 day'));?>" name="tgltelat" class="form-control" id="tgltelat" value="" placeholder="dd-mm-yyyy" required="required">
                          </div>
                            <div class="form-group col-md-6">
                              <label for="inputEmail4">Jam Terlambat</label>
                              <input type="time" max="10:00:00" step="1" name="timetelat" class="form-control timepicker" id="time" placeholder="" required="required">
