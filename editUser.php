...
$infoccbc = "SELECT id,nama FROM masteruser WHERE jabatan='owner' OR jabatan='manager' OR jabatan='supervisor' OR jabatan='direktur';";
...
// WHERE nodar = '" .$idnya . "';";
 ...
 $infoccbc = "SELECT id,nama FROM masteruser WHERE (jabatan='manager' OR jabatan='supervisor' OR jabatan='owner' OR jabatan='direktur') AND password != 'resign' ORDER BY nama ASC;";
			  ...
			  <section class="dar mb-5">
                <div class="container-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="updateuser.php">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-6">
                             ...
                             <div class="form-group col-md-6">
                              ...
                              <input value="<?php echo $nik; ?>" type="text" name="nik" class="form-control" id="inputnik" placeholder="NIK">
                            </div>
                          </div>    
                          <div class="form-row">
                          <div class="form-group col-md-6">
                          ...
                          <div class="form-row">
                             <div class="form-group col-md-6">
                              <label for="inputCity">Area/Kota</label>
                          ...
                          <div class="form-group row">
                            ...
                            <select name="ke" class="custom-select d-block w-100" id="cc2" >
                              <option value="<?php echo $ke ?>"><?php if(!empty($kenama)){echo $kenama;}else{ echo 'Cc/Bc 1';} ?> </option>
                ...
                for($x = 0; $x < sizeof($arrayinfoccbc); $x++){
                  ...
                  ?>
                            ...
                            <select name="ke2" class="custom-select d-block w-100" id="cc2">
                              <option value="<?php echo $ke2 ?>"><?php if(!empty($ke2nama)){echo $ke2nama;}else{ echo 'Cc/Bc 2';} ?></option>
                ...
                for($x = 0; $x < sizeof($arrayinfoccbc); $x++){
                  ...
                  ?>
                            ...
                            <select name="ke3" class="custom-select d-block w-100" id="cc2">
                              <option value="<?php if(!empty($ke3)){echo $ke3;}else{ echo '';} ?>"> <?php if(!empty($ke3nama)){echo $ke3nama;}else{ echo 'Cc/Bc 3';} ?> </option>
                ...
                for($x = 0; $x < sizeof($arrayinfoccbc); $x++){
                  ...
                  ?>
                            ...
                            <select name="ke4" class="custom-select d-block w-100" id="cc2">
                              <option value="<?php echo $ke4 ?>"><?php if(!empty($ke4nama)){echo $ke4nama;}else{ echo 'Cc/Bc 4';} ?></option>
                ...
                for($x = 0; $x < sizeof($arrayinfoccbc); $x++){
                  ...
                  ?>
                            ...
                            <select name="ke5" class="custom-select d-block w-100" id="cc2">
                              <option value="<?php echo $ke5 ?>"><?php if(!empty($ke5nama)){echo $ke5nama;}else{ echo 'Cc/Bc 5';} ?></option>
                ...
                for($x = 0; $x < sizeof($arrayinfoccbc); $x++){
                  ...
                  ?>
                         ...
                         <a class="btn btn-outline-dark" href="https://sidar.id/listedituser.php" >
                            <i class="fa fa fa-reply"></i> Cancel
                        </a>
                        
                        <button type="submit" style="margin-left:15px" class="btn btn-outline-dark">
