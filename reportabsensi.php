...
if($buttonabsenpulang == "1"){
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'ib' AND status = 'absen pulang' ORDER BY tglsubmit DESC, jamsubmit DESC;";    
}


if($buttonabsenpulang != "1" && $buttonabsenmasuk != "1"){
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'ib' ORDER BY tglsubmit DESC, jamsubmit DESC;";
}

$infodarbaru = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'ib' AND status = 'absen masuk' ORDER BY tglsubmit DESC, jamsubmit DESC;";
$infodarbaruview = "SELECT * FROM untukexport WHERE Date_Masuk BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'ib' ORDER BY Date_Masuk DESC, Time_Masuk DESC;";
...
$infodar = "SELECT * FROM absenluarkota WHERE (nama LIKE '".$searchingg."' OR tglsubmit LIKE '".$searchingg."') AND lokasikerja = 'ib' ORDER BY tglsubmit DESC, jamsubmit DESC;";

$infodarbaru = "SELECT * FROM absenluarkota WHERE (nama LIKE '".$searchingg."' OR tglsubmit LIKE '".$searchingg."') AND lokasikerja = 'ib' AND status = 'absen masuk' ORDER BY tglsubmit DESC, jamsubmit DESC;";
$infodarbaruview = "SELECT * FROM untukexport WHERE (Name LIKE '".$searchingg."' OR Date_Masuk LIKE '".$searchingg."' OR Date_Pulang LIKE '".$searchingg."') AND lokasikerja = 'ib' ORDER BY Date_Masuk DESC, Time_Masuk DESC;";
...
if($buttonabsenpulang == "1"){
$infodar = "SELECT * FROM absenluarkota WHERE lokasikerja = 'ib' AND status = 'absen pulang' ORDER BY tglsubmit DESC, jamsubmit DESC LIMIT 70;";
echo 'ok';
}


if($buttonabsenpulang != "1" && $buttonabsenmasuk != "1"){
$infodar = "SELECT * FROM absenluarkota WHERE lokasikerja = 'ib' ORDER BY tglsubmit DESC, jamsubmit DESC LIMIT 70;";    
    
}


$infodarbaru = "SELECT * FROM absenluarkota WHERE lokasikerja = 'ib' AND status = 'absen masuk' ORDER BY tglsubmit DESC, jamsubmit DESC LIMIT 70;";
$infodarbaruview = "SELECT * FROM untukexport WHERE lokasikerja = 'ib' ORDER BY Date_Masuk DESC, Time_Masuk DESC LIMIT 70;";
...
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'IGI Purwosari' ORDER BY tglsubmit DESC";
}

if($buttonabsenpulang == "1"){
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'IGI Purwosari' AND status = 'absen pulang' ORDER BY tglsubmit DESC";    
}else{
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'IGI Purwosari' ORDER BY tglsubmit DESC";
}
...
$infodar = "SELECT * FROM absenluarkota WHERE (nama LIKE '".$searchingg."' OR tglsubmit LIKE '".$searchingg."') AND lokasikerja = 'IGI Purwosari' ORDER BY tglsubmit DESC, jamsubmit DESC;";
...
$infodar = "SELECT * FROM absenluarkota WHERE lokasikerja = 'IGI Purwosari' ORDER BY tglsubmit DESC, jamsubmit DESC LIMIT 70;";
...
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'IGI Bambe' ORDER BY tglsubmit DESC";
}

if($buttonabsenpulang == "1"){
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'IGI Bambe' AND status = 'absen pulang' ORDER BY tglsubmit DESC";    
}else{
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'IGI Bambe' ORDER BY tglsubmit DESC";
}
...
$infodar = "SELECT * FROM absenluarkota WHERE (nama LIKE '".$searchingg."' OR tglsubmit LIKE '".$searchingg."') AND lokasikerja = 'IGI Bambe' ORDER BY tglsubmit DESC, jamsubmit DESC;";
...
$infodar = "SELECT * FROM absenluarkota WHERE lokasikerja = 'IGI Bambe' ORDER BY tglsubmit DESC, jamsubmit DESC LIMIT 70;";
...
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'sda' ORDER BY tglsubmit DESC";
}

if($buttonabsenpulang == "1"){
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'sda' AND status = 'absen pulang' ORDER BY tglsubmit DESC";    
}else{
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND lokasikerja = 'sda' ORDER BY tglsubmit DESC";
}
...
$infodar = "SELECT * FROM absenluarkota WHERE AND (nama LIKE '".$searchingg."' OR tglsubmit LIKE '".$searchingg."') AND lokasikerja = 'sda' ORDER BY tglsubmit DESC, jamsubmit DESC;";
...
$infodar = "SELECT * FROM absenluarkota WHERE lokasikerja = 'sda' ORDER BY tglsubmit DESC, jamsubmit DESC LIMIT 70;";
...
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND (ke='".$iduser."' OR ke2='".$iduser."' OR ke3='".$iduser."' OR ke4='".$iduser."' OR ke5='".$iduser."' ) AND status = 'absen masuk' ORDER BY tglsubmit DESC";
  ...
  $infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND (ke='".$iduser."' OR ke2='".$iduser."' OR ke3='".$iduser."' OR ke4='".$iduser."' OR ke5='".$iduser."' ) ORDER BY tglsubmit DESC";  
...
$infodar = "SELECT * FROM absenluarkota WHERE tglsubmit BETWEEN CAST('".$tglstart."' AS DATE) AND CAST('".$tglend."' AS DATE) AND (ke='".$iduser."' OR ke2='".$iduser."' OR ke3='".$iduser."' OR ke4='".$iduser."' OR ke5='".$iduser."' ) AND status = 'absen pulang' ORDER BY tglsubmit DESC";
...
$infodar = "SELECT * FROM absenluarkota WHERE AND (nama LIKE '".$searchingg."' OR tglsubmit LIKE '".$searchingg."') AND (ke='".$iduser."' OR ke2='".$iduser."' OR ke3='".$iduser."' OR ke4='".$iduser."' OR ke5='".$iduser."' ) ORDER BY tglsubmit DESC, jamsubmit DESC;";
			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                       ...
                       <!-- DataTales Example -->
                          <div class="card shadow mb-4">
                            ...
                            <div class="card-body" style="padding-bottom:0;">
                                ...
                                <form method="POST" action="excelreportabsensix.php" target="_blank">      
                                 <button style="margin-right: 13px;" type="submit" name="buttonexcel" id="excel" value="excel" class="btn <?php echo $styleabsenpulang;?> form-group" >
                                  Export Excel
                                     ...
                                     <input type="hidden" value="<?php echo $infodarbaruview ;?>" name="queryexcel">
                                </form>
                                </div>
                ...
                for($x = 0; $x < sizeof($arrayrdar); $x++){
                      ...
                      $didistributor = $arrayrdar[$x]["didistributor"];
                      if($didistributor == '1'){
                          $didistributor = 'yes';
                      }else{
                           $didistributor = 'no';
...
echo $darsend;                  
                   ...
                   <td ><a style="font-weight:<?php echo $sama ?>; text-transform: uppercase;" id="linkk" href="reportdetailabsensi.php?idnya=<?php echo $arrayrdar[$x]["noabsensi"] ?>"><?php echo $status ?></td></a>
                   <td ><a style="font-weight:<?php echo $sama ?>; text-transform: uppercase;" id="linkk" href="reportdetailabsensi.php?idnya=<?php echo $arrayrdar[$x]["noabsensi"] ?>"><?php echo $didistributor ?></td></a>
	 ...
	 <div class="modal fade" id="konfirmasidownload" tabindex="-1" role="dialog" aria-labelledby="konfirmasiModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex justify-content-center align-items-end">
                    ...
                    <p class="mb-0">Sedang download file</p>
                </div>
