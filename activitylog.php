...
else if ($namaa == "HRD IB" || $namaa == "Admin HRD IB"){

$infomuser = "SELECT * FROM masteruser WHERE lokasikerja = 'ib'";
$queryuser = $conn->query($infomuser);
$arraymuser = mysqli_fetch_all($queryuser, MYSQLI_ASSOC);

} 

else if ($namaa == "HRD IGI Pasuruan" || $namaa == "Admin HRD Pasuruan"){

$infomuser = "SELECT * FROM masteruser WHERE lokasikerja = 'IGI PURWOSARI'";
$queryuser = $conn->query($infomuser);
$arraymuser = mysqli_fetch_all($queryuser, MYSQLI_ASSOC);

} 

else if ($namaa == "HRD IGI Gresik" || $namaa == "Admin HRD Gresik"){

$infomuser = "SELECT * FROM masteruser WHERE lokasikerja = 'IGI BAMBE'";
$queryuser = $conn->query($infomuser);
$arraymuser = mysqli_fetch_all($queryuser, MYSQLI_ASSOC);

} 

else if ($namaa == "HRD SDA" || $namaa == "Admin HRD SDA"){

$infomuser = "SELECT * FROM masteruser WHERE lokasikerja = 'sda'";
$queryuser = $conn->query($infomuser);
$arraymuser = mysqli_fetch_all($queryuser, MYSQLI_ASSOC);
