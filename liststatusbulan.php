...
$month = $_GET['bulan'];
$fssdate = new DateTime(date('Y').'-'.$month.'-01');
$fsdate = new DateTime(date('Y').'-'.$month.'-01');
$fsdate->modify('last day of this month');
$last_day_this_month = $fsdate->format('Y-m-d');
$first_day_this_month = $fssdate->format('Y-m-d');
