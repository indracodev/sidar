...
if ($namaa == "HRD IB" || $namaa == "Admin HRD IB" || $namaa == "Admin HRD Gresik" || $namaa == "Admin HRD Pasuruan" || $namaa == "Admin HRD SDA"  || $namaa == "HRD IGI Pasuruan" || $namaa == "HRD IGI Gresik" || $namaa == "HRD SDA" ){
...
if ($namaa == "HRD IB" || $namaa == "Admin HRD IB"){
...
if ($namaa == "HRD IGI Pasuruan" || $namaa == "Admin HRD Pasuruan"){
...
if ($namaa == "HRD IGI Gresik" || $namaa == "Admin HRD Gresik"){
...
if ($namaa == "HRD SDA" || $namaa == "Admin HRD SDA"){
			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                       ...
                       <!-- DataTales Example -->
                          <div class="card shadow mb-4">
                            <div class="card-header py-3">
                             <h4 class="card-title m-0 text-uppercase font-weight-bold">Set Resign </h4>
                            </div>
                                <div class="card-body">
                                 <h6>Period Filter:</h6>
                                 <div class="row">
                ...
                for($x = 0; $x < sizeof($arrayrdar); $x++){
                      $status = $arrayrdar[$x]["password"];
                      $namanya = $arrayrdar[$x]['nama'];
                 
                       $ius = "$iduser";
                  
         
                      
                      if ($status != "resign" && $status != "VjkxWU1ZS3NNZzNuai83WGpkVU1kZz09"){
                   $echosts = '<span class="badge badge-success">Active</span>';
                          $echostatus = 'bgcolor="green"';
                      }else{
                     $echosts = '<span class="badge badge-danger">Resign</span>';
                  ...
                  <tr> 
                    <td scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="status.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["nama"] ?></td> </a>
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="status.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["departemen"] ?></td></a>
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="status.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>&nama=<?php echo $arrayrdar[$x]["nama"] ?>"><?php echo $arrayrdar[$x]["divisi"] ?></td></a>
                    <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="status.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php echo $echosts ?></td></a>
          
                    <td style="width: 15%;"><a style="font-weight:<?php echo $sama ?>; font-size: 99%;" id="linkk" href="setresign.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>"><button style="font-size: 99%;" class="btn btn-danger">Set Resign</button></td></a>
                    <td style="width: 15%;"><a style="font-weight:<?php echo $sama ?>; font-size: 99%;" id="linkk" href="setactive.php?idnya=<?php echo $arrayrdar[$x]["id"] ?>"><button style="font-size: 99%;" class="btn btn-success">Set Active</button></td></a> 
