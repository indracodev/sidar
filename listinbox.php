...
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.divisi, masteruser.kota, masteruser.unitusaha, inbox.status, inbox.sudahbaca, inbox.tanggaldar, inbox.jam, inbox.tanggal, inbox.noinbox FROM inbox INNER JOIN masteruser ON masteruser.id=inbox.iduser WHERE inbox.todiuser='".$iduser."' AND (inbox.subject LIKE '".$searchingg."' OR inbox.message LIKE '".$searchingg."' OR masteruser.nama LIKE '".$searchingg."') ORDER BY inbox.tanggal DESC, inbox.jam DESC;";
