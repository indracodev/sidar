...
$_SESSION["IDlistreport"] = $_GET["idnya"];
$idnya = $_SESSION["IDlistreport"];
...
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE dar.iduser='".$idnya."' AND (dar.activity LIKE '".$searchingg."' OR dar.plan LIKE '".$searchingg."' OR dar.result LIKE '".$searchingg."' OR masteruser.nama LIKE '".$searchingg."') ORDER BY dar.tanggal DESC, dar.jam DESC;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
mysqli_close($conn);
...
if($_SESSION["readfilter"] == "1"){        
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE dar.iduser='".$idnya."' AND sudahbaca NOT LIKE '%".$idnya."|%' ORDER BY dar.tanggaldar DESC, dar.jam DESC LIMIT 70;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
mysqli_close($conn);
}else{
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE dar.iduser='".$idnya."' ORDER BY dar.tanggaldar DESC, dar.jam DESC LIMIT 70;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
mysqli_close($conn);    
			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                ...
                $echosts = '<span class="badge badge-decline" style="color:white;">Decline</span>';  
                  ...
                  <tr> 
                    <td scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetaild.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php echo $arrayrdar[$x]["unitusaha"] ?></td> </a>
                    <td scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetaild.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php echo $arrayrdar[$x]["departemen"] ?></td> </a>
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetaild.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php echo $arrayrdar[$x]["nama"] ?></td></a>
                    <td data-sort="<?php echo $mydate; ?>"><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetaild.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php 
...
$tgldar = $daydar .'-'. $mondar .'-'. $yerdar;
                    ...
                    echo $tgldar; ?></td></a>
                    <td data-sort="<?php echo $mydatesent; ?>"><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetaild.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php
...
echo $darsend;                  
                   ...
                   <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetaild.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php echo $echosts ?></td></a>
          
                   
                   
                    <td style="display:none" ><a id="linkk" style="font-weight:<?php echo $sama ?>;" href="reportdetaild.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php echo $arrayrdar[$x]["tag"] ?></td></a>
