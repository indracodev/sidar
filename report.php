...
if(!empty($datefilter)){
$_SESSION["filtertanggal"] = $datefilter;
}
if($_POST['backlapor'] == "ya"){
$datefilter = $_SESSION["filtertanggal"];
}
...
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.divisi, masteruser.kota, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE dar.iduser='".$iduser."' ORDER BY dar.tanggaldar DESC, dar.jam DESC LIMIT 70;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
mysqli_close($conn);    
              ...
              <section class="dar mb-5">
                ...
                $echosts = '<span class="badge badge-decline" style="color:white;">Decline</span>';  
                  ...
                  <tr> 
                    ...
                    <td><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetail.php?idnya=<?php echo $arrayrdar[$x]["nodar"] ?>"><?php echo strtoupper($arrayrdar[$x]["nama"]) ?></td></a>
