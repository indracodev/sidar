...
header("Location: http://icg.id/beta/dar/");
...
<body>
	...
	<div class="wrapper">
        ...
        <main class="login shadow">
            ...
            <div class="w-100">
              <div class="center">
                   <h2 class="font-weight-bold text-center" style="letter-spacing: 4px;">SIDAR</h2> <h5>beta</h5> 
              </div>
                ...
                <form action="../login.php" method="post" class="mb-2">
                    <input type="text" name="username" class="form-control p-4 rounded-pill mb-2" placeholder="Username" required>
                    <input type="password" name="password" class="form-control p-4 rounded-pill" placeholder="Password" required>
               
                <div style="display:none" class="mb-5">
