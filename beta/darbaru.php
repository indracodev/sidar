			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                                <h4 class="card-title m-0 text-uppercase font-weight-bold">ACTIVITY</h4>
...
<td class="column1">develop web shop manual</td>
<td class="column2">memperbaiki data user sidar</td>
<td class="column3">process</td>
<td class="column4">30-04-2020</td>
<td class="column5">30-04-2020</td>
<td class="column6"><i class="fa fa-arrow-down"></i></td>
</tr>
...
<td style="display:none;"></td>    
<td style="display:none;"></td>
<td class="column1" style="font-weight: bold;">Explaination :</td>
<td style="">Meyiapkan file cetak stiker program [ kirim program ke purchasing ]</td>
</tr>
<tr style="" class="content">
<td style="display:none;"></td>    
<td style="display:none;"></td>  
...
<tr class="collapsible">
<td class="column1">develop web sidar</td>
<td class="column2">memperbaiki data user sidar</td>
<td class="column3">process</td>
<td class="column4">30-04-2020</td>
<td class="column5">30-04-2020</td>
...
<tr class="collapsible">
<td class="column1">Follow up design aproval stempel & stiker program</td>
<td class="column2">Meyiapkan file cetak stiker program [ kirim program ke purchasing ]</td>
<td class="column3">process</td>
<td class="column4">30-04-2020</td>
<td class="column5">30-04-2020</td>
<td class="column6"><i class="fa fa-arrow-down"></i></td>
...
<tr class="collapsible">
<td class="column1">Stiker IB dan IGI</td>
<td class="column2">layut stiker ruangan A3+ ke A4 [ file kirim ke purchasing ]</td>
<td class="column3">process</td>
<td class="column4">30-04-2020</td>
<td class="column5">30-04-2020</td>
<td class="column6"><i class="fa fa-arrow-down"></i></td>
...
<tr class="collapsible">
<td class="column1">Konsep dinding amplop</td>
<td class="column2">Meyiapkan file cetak stiker program [ kirim program ke purchasing ]</td>
<td class="column3">process</td>
<td class="column4">30-04-2020</td>
<td class="column5">30-04-2020</td>
...
<td style="">Meyiapkan file cetak stiker program [ kirim program ke purchasing ]</td>
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                                <h4 class="card-title m-0 text-uppercase font-weight-bold">EXPLAINATION</h4>
                               
                                <div class="dropdown">
                                        <div id="dropCardHeader" aria-haspopup="true" aria-expanded="false">
                                        <button class="btn btn-outline-dark" data-toggle="modal" data-target="#konfirmasiDraft">
                                        <i class="fa fa-plus"></i> ADD EXPLAINATION
                                             </button>
                                        </div>
...
<th class="column3">Explaination</th>
<th class="column4">Date</th>
<th class="column5">Due Date</th>
...
<td class="column5">6</td>
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                                <h4 class="card-title m-0 text-uppercase font-weight-bold">PROOF</h4>
...
for (i = 0; i < coll.length; i++) {
  coll[i].addEventListener("click", function() {
    ...
    var content = this.nextAll().slice(0, 2);
