...
if($_SESSION["readfilter"] == "1"){        
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE dar.iduser='".$iduser."' AND sudahbaca NOT LIKE '%".$iduser."|%' ORDER BY dar.tanggaldar DESC, dar.jam DESC LIMIT 70;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
mysqli_close($conn);
}else{
$infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE dar.iduser='".$iduser."' ORDER BY dar.tanggaldar DESC, dar.jam DESC LIMIT 70;";
$querydar = $conn->query($infodar);
$arrayrdar = mysqli_fetch_all($querydar, MYSQLI_ASSOC);
mysqli_close($conn);    
...
if($_SESSION["readfilter"] == "1"){
  $infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) AND sudahbaca NOT LIKE '%".$iduser."|%' ORDER BY dar.tanggal DESC, dar.jam DESC LIMIT 70;";
...
mysqli_close($conn);  
    ...
    $infodar = "SELECT masteruser.nama, masteruser.departemen, masteruser.unitusaha, dar.status, dar.sudahbaca, dar.tanggaldar, dar.jam, dar.tanggal, dar.nodar, dar.tag FROM dar INNER JOIN masteruser ON masteruser.id=dar.iduser WHERE (dar.iduser='".$iduser."' OR dar.ke='".$iduser."' OR dar.ke2='".$iduser."' OR dar.ke3='".$iduser."' OR dar.ke4='".$iduser."' OR dar.ke5='".$iduser."' ) ORDER BY dar.tanggal DESC, dar.jam DESC LIMIT 70;";
                                 ...
                                 <div class="row" style="<?php echo $aktifbaca ; ?>">
                                  ...
                                  <div class='col-sm-3' style="max-width:100%;flex-basis:100%;">
                                    <div class="form-group">
                                        ...
                                        <form method="POST" action="">
                                <!--    <input type="text" class="form-control" name="datefilter"  id="datefilter"> -->
                                     <button type="submit" name="aktifbaca" id="aktifbaca" value="aktifbaca" class="btn btn-outline-dark form-control">
                                  Not Active
                                     </button>
                                  ...
                                  <div class='col-sm-3' style="max-width:100%;flex-basis:100%;">
                                    <div class="form-group">
                                        ...
                                        <form method="POST" action="">
                                <!--    <input type="text" class="form-control" name="datefilter"  id="datefilter"> -->
                                      <button type="submit" style="color:white;" name="bacatidakaktif" id="bacatidakaktif" value="bacatidakaktif" class="btn btn-outline-dark btn-success form-control">
                                    Active
                                     </button>
                                     </form>
...
echo $darsend;                  
                   ...
                   <td ><button type="submit"><?php echo $echosts ?></button></td>
          
                   
                   
                    <td style="display:none" ><button type="submit"><?php echo $arrayrdar[$x]["tag"] ?> </button></td>
         
         <input style="display:none" type="text" name="idnya" value="<?php echo $arrayrdar[$x]["nodar"] ?>">
          </form>
                  </tr>
                  <?php } ?>
                                  </tbody>
