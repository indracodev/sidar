 ...
 */
 ...
 $updatelog = "INSERT INTO todo (iduser, target, todo, result, date, duedate, datecreated, tampil) VALUE ('".$IUser."', '".$target."', '".$todo."', '".$result."', '".$tanggaldate."', '".$tanggalduedate."', '".$tanggal."', 'ya')"; 
