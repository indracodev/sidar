...
$infotodo = "SELECT * FROM draftddar WHERE iduser='".$iduser."' AND result != 'done'  ";
...
<body>
	...
	<div class="wrapper">
        ...
        $arrayrattach = mysqli_fetch_all($queryattach, MYSQLI_ASSOC);
                  ...
                  <tr> 
                   <td class="dtr-control" style="align-text:center;"></td>
                    <td class="align-middle" scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetail.php?idnya=<?php echo $arraytodo[$x]["idtodo"] ?>"><?php echo $arraytodo[$x]["target"] ?></td> </a>
                    <td class="align-middle" scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetail.php?idnya=<?php echo $arraytodo[$x]["idtodo"] ?>"><?php echo $arraytodo[$x]["activity"] ?></td> </a>
                ...
                for($v = 0; $v < sizeof($arrayrattach); $v++){
                  ...
                  <?php } ?>
                    ...
                    <td class="align-middle" data-sort="<?php echo $mydate; ?>"><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetail.php?idnya=<?php echo $arraytodo[$x]["idtodo"] ?>"><?php 
                 $tanggaldar = $arraytodo[$x]["date"];
...
echo $tgl;                  
               ...
               <td ><a id="linkk" href="hapusdraftddar.php?idnya=<?php echo $arraytodo[$x]["iddetdar"] ?>"> <button class="btn btn-outline-dark" id="myBtn" >Delete </button></td></a>
