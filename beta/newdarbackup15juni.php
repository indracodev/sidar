        ...
        $arrayrattach = mysqli_fetch_all($queryattach, MYSQLI_ASSOC);
                  ...
                  <tr> 
                   <td class="dtr-control text-center"></td>
                    <td class="align-middle" scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetail.php?idnya=<?php echo $arraytodo[$x][""] ?>"><?php echo $arraytodo[$x]["target"] ?></td> </a>
