			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                       ...
                       <!-- DataTales Example -->
                          <div class="card shadow mb-4">
                            <div class="card-header py-3">
                             <h4 class="card-title m-0 text-uppercase font-weight-bold">Management User Detail</h4>
                            </div>
                ...
                for($x = 0; $x < sizeof($arraymuser); $x++){
                  ?>
                  <tr> 
                    <td scope="row"> <a id="linkk" href="edituser.php?idnya=<?php echo $arraymuser[$x]["id"] ?>"><?php echo $arraymuser[$x]["nama"] ?></td> </a>
                    <td><a id="linkk" href="edituser.php?idnya=<?php echo $arraymuser[$x]["id"] ?>"><?php echo $arraymuser[$x]["unitusaha"] ?></td></a>
                    <td><a id="linkk" href="edituser.php?idnya=<?php echo $arraymuser[$x]["id"] ?>"><?php echo $arraymuser[$x]["departemen"] ?></td></a>
                    <td ><a id="linkk" href="edituser.php?idnya=<?php echo $arraymuser[$x]["id"] ?>"><?php echo $arraymuser[$x]["divisi"] ?></td></a>
                    <td ><a style="text-transform:uppercase;" id="linkk" href="edituser.php?idnya=<?php echo $arraymuser[$x]["id"] ?>"><?php echo $arraymuser[$x]["jabatan"] ?></td></a>
