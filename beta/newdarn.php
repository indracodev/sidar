			...
			<!-- letakkan isi konten disini ! -->
              <section class="dar mb-5">
                ...
                for($x = 0; $x < sizeof($arraytodo); $x++){
                  ...
                  <tr> 
                    <td></td>
                    <td scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetail.php?idnya=<?php echo $arraytodo[$x]["idtodo"] ?>"><?php echo $arraytodo[$x]["target"] ?></td> </a>
                 ...
                 <td></td>
                 <td></td>
                    <td data-sort="<?php echo $mydate; ?>"><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetail.php?idnya=<?php echo $arraytodo[$x]["idtodo"] ?>"><?php 
...
echo $tgl;                  
                   ...
                   <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetail.php?idnya=<?php echo $arraytodo[$x]["idtodo"] ?>"> <button class="btn btn-outline-dark" id="myBtn" >
                                        Edit
                                             </button></td></a>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="insertodo.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="explaination" id="explaination" placeholder="Todo"/>
                    </div>
                     <div class="form-group">
                        <label for="result">Result</label>
                        <input type="text" class="form-control" name="result" id="result" placeholder="Todo"/>
                    </div>
                        <div class="form-group">
                    <label>Date</label>
                    <div>
