...
$sql = "SELECT * FROM mastertarget WHERE iduser = '".$iduser."' AND result != 'done' ";
              ...
              <section class="dar mb-5">
                ...
                for($x = 0; $x < sizeof($arraytodo); $x++){
                     ...
                     if($arraytodo[$x]["tampil"] == "tidak"){
                      ...
                      if($arraytodo[$x]["bisatambahdar"] == "tidak"){
                         $textbutton = "Added to DAR";
                        $bisatambahdar = "disabled"; 
                     }else{
                         $bisatambahdar = ""; 
                         $textbutton = "Add to DAR";
                     }
                     
                  ?>
                
                 
                  <tr style="<?php echo $tampilan ?>"> 
...
echo $tgl;                  
                   ...
                   ?></td></a>
                    ...
                    <td ><a style="font-weight:<?php echo $sama ?>;" id="linkk" href="addtodar.php?idnya=<?php echo $arraytodo[$x]["idtodo"] ?>"> <button class="btn btn-outline-dark" id="myBtn" <?php echo $bisatambahdar ?> >
                                      <?php echo $textbutton ?>
                                             </button></td></a>
...
<div class="modal fade" id="myModaldt" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                  <h4 class="modal-title" id="labelModalKu">DELETE TARGET</h4>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                    <span class="sr-only">Tutup</span>
                </button>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="deletetarget.php">
                    <div class="form-group">
                        ...
                        <select name="target" class="form-control" name="target" id="target">
                        <?php for($x = 0; $x < sizeof($arrayresult); $x++){ ?>    
                        <option value="<?php echo $arrayresult[$x]['idtarget'] ?>/<?php echo $arrayresult[$x]['namatarget'] ?>"><?php echo $arrayresult[$x]['namatarget'] ?></option>
