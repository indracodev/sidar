...
$infotodo = "SELECT DISTINCT target, nodar FROM ddar WHERE nodar='".$idnya."' ";
	...
	<div class="wrapper">
        ...
        $arrayrattach = mysqli_fetch_all($queryattach, MYSQLI_ASSOC);
                  ...
                  <tr> 
                    ...
                    <td class="align-middle" scope="row"> <a style="font-weight:<?php echo $sama ?>;" id="linkk" href="reportdetaildar.php?idnya=<?php echo $arraytodo[$x]["nodar"] ?>&target=<?php echo $arraytodo[$x]["target"] ?>"><?php echo $arraytodo[$x]["target"] ?></td> </a>
