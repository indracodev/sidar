...
const model = {
   ...
   // URL: 'http://192.168.1.95/patrol/api/v1/',
    ...
    addTask: function (query, handlers) {
        let urlencoded = new URLSearchParams()
    ...
    editTask: function (query, handlers) {
        let urlencoded = new URLSearchParams()
        urlencoded.append("id", query.id)
        urlencoded.append("task", query.task)
        urlencoded.append("hash", query.hash)
    ...
    rmTask: function (query, handlers) {
        let urlencoded = new URLSearchParams()
        urlencoded.append("id", query.id)
        urlencoded.append("hash", query.hash)
    ...
    getTask: function (query, handlers) {
        fetch(`${this.URL}task/?hash=${query.hash}&device=web&action=task`, {
            method: 'GET',
            redirect: 'follow'
        })
            .then(response => response.text())
    ...
    setTask: function (query, handlers) {
        let urlencoded = new URLSearchParams()
        urlencoded.append("id", query.id)
        urlencoded.append("activity", query.activity)
        urlencoded.append("task", query.task)
        ...
        fetch(`${this.URL}task/?device=web`, {
            method: 'PATCH',
            body: urlencoded,
            redirect: 'follow'
        })
    ...
    addTemplate: function (query, handlers) {
        let urlencoded = new URLSearchParams()
    ...
    getTemplate: function (query, handlers) {
    ...
    rmTemplate: function (query, handlers) {
        let urlencoded = new URLSearchParams()
        urlencoded.append("template", query.template)
        urlencoded.append("hash", query.hash)
