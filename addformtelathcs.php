...
if($namae != $namaa){
header("Location: https://sidar.id/sendnotiftelathcs.php");    
}
		...
		<main class="konten">
			  <section class="dar mb-5">
                <div class="container-fluid">
                    <div class="kiri" >
                            <form method="post" action="sendnotiftelathcs.php">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="tambahdatatelat.php">
                          ...
                          <div class="form-row">
                          <div class="form-group col-md-6">
                            <label class="mr-sm-2" for="inlineFormCustomSelect">Tanggal Terlambat</label>
                            <input type="date" name="tgltelat" class="form-control" id="tgltelat" value="" placeholder="dd-mm-yyyy" required="required">
                          </div>
                            <div class="form-group col-md-6">
                              <label for="inputEmail4">Jam Terlambat</label>
                              <input type="time" value="09:15" name="timetelat" class="form-control timepicker" id="time" placeholder="" required="required">
                           ...
                           <div class="form-group col-md-6">
                               <label class="mr-sm-2" for="inlineFormCustomSelect">Menyetujui Pimpinan Departement</label>
                                <select name="keatasan" class="custom-select mr-sm-2" id="inlineFormCustomSelect" required="required">
                                  <option value="<?php echo $ke1 ;?>" selected><?php if(!empty($adduserdepartement)){echo $adduserdepartement;}else{echo 'Choose...';}  ;?></option>
