...
$acceptabsence = "UPDATE formtelat SET menyetujuiatasan='Setuju' WHERE notelat='".$ntelat."' ";       

if ($conn->query($acceptabsence) === TRUE) {

   $updatelogsalahpass = "INSERT INTO formtelatsetuju (notelat, tanggal, jam, iduseryangsetuju, ip, userdevice, status) VALUE ('".$ntelat."', '".$datetimee."', '".$jam."', '".$userid."', '".$ip."', '".$useragent."', 'Setuju')"; 
