...
$acceptabsence = "UPDATE formcuti SET menyetujuiatasan='Tidak' WHERE nocuti='".$ntelat."' ";       

if ($conn->query($acceptabsence) === TRUE) {

   $updatelogsalahpass = "INSERT INTO formcutisetuju (nocuti, tanggal, jam, iduseryangsetuju, ip, userdevice, status) VALUE ('".$ntelat."', '".$datetimee."', '".$jam."', '".$userid."', '".$ip."', '".$useragent."', 'Tidak')"; 
