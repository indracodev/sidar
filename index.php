...
$ambilizintelatatas = "SELECT * FROM formtelat WHERE ke1 = '" .$iduser. "' AND menyetujuiatasan = 'Belum' ORDER BY id DESC LIMIT 1 ;";
...
$nodarnya = $iduser."/".$hasil;
    ...
    // header("location: https://www.sidar.id/login");
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<!-- Required meta tags -->
    <meta name="description" content="SIDAR"/>
							...
							<div class="card mb-3">
								<div class="card-header d-flex justify-content-between align-items-center">
									...
									<div class="card-body" style="height: 300px;">
								      ...
								      <div class="keterangan text-left" style="padding-left: 2.8rem;margin-top:10px">
                                        <span class="mr-1">
                                         <a id="alink" href="liststatusminggu.php?stat=ontime"> <i class="fa fa-circle" style="color:#28a745;"></i> 
                                            <normal>Ontime</normal></a>
                                        </span>
                                        <span class="mr-1">
                                          <a id="alink" href="liststatusminggu.php?stat=late">   <i class="fa fa-circle" style="color:#ffc107;"></i> 
                                            <normal>Late</normal> </a>
                                        </span>
                                        <span class="mr-1">
                                          <a id="alink" href="liststatusminggu.php?stat=over">   <i class="fa fa-circle" style="color:#cc0201 "></i>
                                            <normal>Over</normal> </a>
                                        </span>
                                        <span class="mr-1">
                                         <a id="alink" href="liststatusminggu.php?stat=nodata">    <i class="fa fa-circle" style="color:#ffffc "></i>
                                            <normal>No Data</normal> </a>
                                        </span>
                                         <span class="mr-1">
                                          <a id="alink" href="liststatusminggu.php?stat=absence">   <i class="fa fa-circle" style="color:blue "></i>
                                            <normal>Absence</normal> </a>
                                        </span>
                                    </div>
									</div>
								</div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="keterangan text-center">
                                        <span class="mr-3">
                                      <a id="alink" href="liststatusharian.php?stat=ontime"> <i class="fa fa-circle" style="color: #28a745;"></i> <small>Ontime</small> </a>
                                        </span>
                                        <span class="mr-3">
                                       <a id="alink" href="liststatusharian.php?stat=late"> <i class="fa fa-circle" style="color: #ffc107;"></i> <small>Late</small> </a>
                                        </span>
                                        <span class="mr-3">
                                       <a id="alink" href="liststatusharian.php?stat=over"> <i class="fa fa-circle" style="color: #cc0201;"></i> <small>Over</small> </a>
                                        </span>
                               
                                <br>
                                        <span class="mr-3">
                                       <a id="alink" href="liststatusharian.php?stat=absence"> <i class="fa fa-circle" style="color: blue;"></i> <small>Absence</small> </a>
                                        </span>
                                        <span class="mr-3">
                                           <a id="alink" href="liststatusharian.php?stat=nodata"> <i class="fa fa-circle" style="color: #ffffc;"></i> <small>No Data</small> </a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                 ...
                                 <div class="card card-default pb-5">
                                    ...
                                    <div class="keterangan text-left" style="padding-left: 3.8rem;">
                                        <span class="mr-1">
                                        <a id="alink" href="daftarbulanstatus.php?stat=ontime">    <i class="fa fa-circle" style="color:#28a745;"></i> 
                                            <normal>Ontime</normal></a>
                                        </span>
                                        <span class="mr-1">
                                         <a id="alink" href="daftarbulanstatus.php?stat=late">   <i class="fa fa-circle" style="color:#ffc107;"></i> 
                                            <normal>Late</normal> </a>
                                        </span>
                                        <span class="mr-1">
                                          <a id="alink" href="daftarbulanstatus.php?stat=over">  <i class="fa fa-circle" style="color:#cc0201 "></i>
                                            <normal>Over</normal> </a>
                                        </span>
                                        <span class="mr-1">
                                         <a id="alink" href="daftarbulanstatus.php?stat=nodata">   <i class="fa fa-circle" style="color:#ffffc "></i>
                                            <normal>No Data</normal></a>
                                        </span>
                                         <span class="mr-1">
                                        <a id="alink" href="daftarbulanstatus.php?stat=absence">    <i class="fa fa-circle" style="color:blue "></i>
                                            <normal>Absence</normal></a>
                                        </span>
                                    </div>
                                </div><!--card body-->
...
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["Ontime", "Over", "Late", "Pending Absence", "NoData"],
    datasets: [{
      data: [<?php echo $varontime; ?>, <?php echo $varover; ?>, <?php echo $varlatesatu; ?>, <?php echo $varpendingabsence; ?>, <?php echo $jumlahmuser; ?> ], 
      backgroundColor: ['#28a745', '#dc3545', '#ffc107','teal','black'],
