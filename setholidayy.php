...
$holiday = $_POST['isiholiday'];

echo $holiday;

$pecahtgl = explode(" ", $holiday);
...
$acceptholiday .= "UPDATE mastertanggal5 SET $bln='libur' WHERE id='".$tglhar."' ";




if ($conn->query($acceptholiday) === TRUE) {
echo '<script>
	alert("Holiday berhasil di set");
